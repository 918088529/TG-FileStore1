...
class Config(object):
	...
	API_HASH = os.environ.get("cb7098aa919c29da3e5f9af0f9086dd7")
	BOT_TOKEN = os.environ.get("5981596323:AAEbMFRaZJ5OL-kWcONCllLfNPqWZ3DMIeQ")
...
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](@Chart_122122_bot)
│
├🔸🔔 **Bot Updates:** [Updats](https://t.me/ideal_bot_father)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [@𝐏𝐫𝐞𝐝𝐚𝐭𝐨𝐫𝐇𝐚𝐜𝐤𝐞𝐫𝐳𝐙](https://t.me/ideal_bot_father) 
...
[**Donate Me**](8088529720@paytm) (paytm)
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
